  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?= BASEURL ?>/projek/dashboard">
     ...
     <li class="nav-item ">
        <a class="nav-link" href="<?= BASEURL ?>/projek/index">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= BASEURL ?>/projek/user">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?= BASEURL ?>/projek/laporan">
